 ...
 * 
 */
package ShopImportDeamon.General;
...
/**
 * Класс отвечает за получение данных из файла конфигурации приложения. Данный
 * класс является singleton классом.
 *
...
public class Configuration {
    ...
    private static final String[] propertiesFilePaths = {"pathName", "directory"};
    ...
    private Configuration() {
        ...
        this.readConfigurationBlockData("FilePaths", "FilePaths", "Path", "pathName", propertiesFilePaths);
    }
