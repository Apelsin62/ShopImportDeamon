...
/**
 * Документ поулченный из XML файла выгрузки
 *
...
public class ImportDocument {
    ...
    private static final String rootTagName = "ImportData";

    public static void setDocument(String filePath) {
        ImportDocument.doc = XMLHelper.getXMLDOC(filePath);
    }
    ...
    public static Node getRootNode() {
        return ImportDocument.getDocument().getElementsByTagName(ImportDocument.getTagName()).item(0);
    }
}
